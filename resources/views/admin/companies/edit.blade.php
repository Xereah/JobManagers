    ...
    <form action="{{ route("admin.companies.update", [$company->kontrahent_id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_kod') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_kod" name="kontrahent_kod" class="form-control" value="{{ old('kontrahent_kod', isset($company) ? $company->kontrahent_kod : '') }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_nazwa1') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_nazwa1" name="kontrahent_nazwa1" value="{{ old('kontrahent_nazwa1', isset($company) ? $company->kontrahent_nazwa1 : '') }}" class="form-control">
                ...
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_nazwa2') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_nazwa2" name="kontrahent_nazwa2" value="{{ old('kontrahent_nazwa2', isset($company) ? $company->kontrahent_nazwa2 : '') }}" class="form-control">
                    @if($errors->has('name'))
                    <em class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </em>
            ...
            <div class="form-row">
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_nazwa3') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_nazwa3" name="kontrahent_nazwa3" value="{{ old('kontrahent_nazwa3', isset($company) ? $company->kontrahent_nazwa3 : '') }}" class="form-control">
                ...
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_nip') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_nip" name="kontrahent_nip" value="{{ old('kontrahent_nip', isset($company) ? $company->kontrahent_nip : '') }}" class="form-control">
            ...
            <div class="form-group col-md-4 {{ $errors->has('kontrahent_miasto') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_miasto" name="kontrahent_miasto" value="{{ old('kontrahent_miasto', isset($company) ? $company->kontrahent_miasto : '') }}" class="form-control">
                ...
                <div class="form-group col-md-4  {{ $errors->has('kontrahent_ulica') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_ulica" name="kontrahent_ulica" value="{{ old('kontrahent_ulica', isset($company) ? $company->kontrahent_ulica : '') }}" class="form-control">
                ...
                <div class="form-group col-md-2 {{ $errors->has('kontrahent_nrdomu') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_nrdomu" name="kontrahent_nrdomu" value="{{ old('kontrahent_nrdomu', isset($company) ? $company->kontrahent_nrdomu : '') }}" class="form-control">
                ...
                <div class="form-group col-md-2 {{ $errors->has('kontrahent_nrlokalu') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_nrlokalu" name="kontrahent_nrlokalu" value="{{ old('kontrahent_nrlokalu', isset($company) ? $company->kontrahent_nrlokalu : '') }}" class="form-control">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_kodpocztowy') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_kodpocztowy" name="kontrahent_kodpocztowy" value="{{ old('kontrahent_kodpocztowy', isset($company) ? $company->kontrahent_kodpocztowy : '') }}" class="form-control">
                ...
                <div class="form-group col-md-6 {{ $errors->has('location') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_poczta" name="kontrahent_poczta" value="{{ old('kontrahent_poczta', isset($company) ? $company->kontrahent_poczta : '') }}" class="form-control">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_telefon1') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_telefon1" name="kontrahent_telefon1" value="{{ old('kontrahent_telefon1', isset($company) ? $company->kontrahent_telefon1 : '') }}" class="form-control">
                ...
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_telefon2') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_telefon2" name="kontrahent_telefon2" value="{{ old('kontrahent_telefon2', isset($company) ? $company->kontrahent_telefon2 : '') }}" class="form-control">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_email') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_email" name="kontrahent_email" value="{{ old('kontrahent_email', isset($company) ? $company->kontrahent_email : '') }}" class="form-control">
                ...
                <div class="form-group col-md-6 {{ $errors->has('kontrahent_odleglosc') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="kontrahent_odleglosc" name="kontrahent_odleglosc" value="{{ old('kontrahent_odleglosc', isset($company) ? $company->kontrahent_odleglosc : '') }}" class="form-control">
