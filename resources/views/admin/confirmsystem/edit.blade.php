    ...
    <div class="card col-md-8 mx-auto">
        <div class="card-horizontal">
            <ul class="list-group py-3">
                ...
                <li class="list-group-item"><input type="button"
                        class="btn btn-danger float-left btn-floating addtowar col-md-12 addtowar_pill" value="Dodaj towary"></li>
                <li class="list-group-item"><input type="button"
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end py-2">
            ...
            <a href="{{ url('/SendMail', [$job->id]) }}">
                <input class="btn bg-success  float-right" onclick="return confirm('{{ trans('global.areYouSure') }}');" type="button" value="Wyślij Mail"></a>
            ...
            <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">                                       
                                    <input name="user_order" hidden class="form-control" value="{{ $job->fk_user }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div >
                                 @can('job_delete')
                                    ...
                                    href="{{ url('/eq_delete', $job->id) }}"  onclick="return confirm('{{ trans('global.areYouSure') }}');">
                                    Usuń
                                    </a>
                                @endcan
            </div>
        ...
        <div class="tab-pane fade" id="pills-towary" role="tabpanel" aria-labelledby="pills-towary-tab">
            ...
            <div class="card mx-auto">
                ...
                <div >
                                 @can('job_delete')
                                    <a class="btn btn-xs col-md-1 float-right  btn-danger"
                                    href="{{ url('/eq_delete', $jobs_towarys->id) }}"  onclick="return confirm('{{ trans('global.areYouSure') }}');">
                                    Usuń
                                    </a>
                                @endcan
            </div>
        ...
        <div class="tab-pane fade" id="pills-equipment" role="tabpanel" aria-labelledby="pills-equipment-tab">
            ...
            <div class="card mx-auto">
                            ...
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <select name="fk_rep_eq[]" id="fk_rep_eq[]" required disabled class="form-control select2"
                                            required>
                                    ...
                                    <div>
                                        ...
                                        <textarea required class="form-control" required disabled name="description_eq[]" id="description_eq[]"
                ...
                <div >
                                 @can('job_delete')
                                    <a class="btn btn-xs col-md-1 float-right  btn-danger"
                                    href="{{ url('/is_loan_delete', $jobs_sprzetzasts->id) }}"  onclick="return confirm('{{ trans('global.areYouSure') }}');">
                                    Usuń
                                    </a>
                                @endcan
            </div>
                    ...
                    <tr data-entry-id="{{ $RepEquipments->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs col-md-12  btn-success"
                                href="{{ url('/is_loan', $RepEquipments->id) }}" onclick="return confirm('{{ trans('global.areYouSure') }}');">
                                Zwrot
                            </a>
                            @endcan
