...
<div class="card col-md-6 mx-auto">
    ...
    <form action="{{ route("admin.car.update", [$car->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('car_mark') ? 'has-error' : '' }}">
                ...
                <input type="text" id="car_mark" name="car_mark" class="form-control" value="{{ $car->car_mark }}" >
            ...
            <div class="form-group {{ $errors->has('car_model') ? 'has-error' : '' }}">
                ...
                <input type="text" id="car_model" name="car_model" class="form-control" value="{{ $car->car_model }}" >
            ...
            <div class="form-group {{ $errors->has('car_plates') ? 'has-error' : '' }}">
                ...
                <input type="text" id="car_plates" name="car_plates" class="form-control" value="{{ $car->car_plates }}" >
